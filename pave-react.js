...
var createComponent = exports.createComponent = function createComponent(Component, _ref) {
  ...
  return _temp2 = _class = function (_ReactComponent) {
    ...
    function _class() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = _class.__proto__ || Object.getPrototypeOf(_class)).call.apply(_ref2, [this].concat(args))), _this), _this.params = params, _this.isMounted = true, _temp), _possibleConstructorReturn(_this, _ret);
    }
